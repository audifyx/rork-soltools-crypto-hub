...
const PALETTES: { id: string; name: string; colors: [string, string] }[] = [
  ...
  { id: "sunset", name: "Sunset", colors: ["#FF6B6B", "#FFB36B"] },
  { id: "ember", name: "Ember", colors: ["#FF5E3A", "#FF2A68"] },
  { id: "magma", name: "Magma", colors: ["#FF2D55", "#FF9500"] },
  { id: "peach", name: "Peach", colors: ["#FFB199", "#FF7AA2"] },
  { id: "coral", name: "Coral", colors: ["#FF7A59", "#FFC163"] },
  { id: "flamingo", name: "Flamingo", colors: ["#FF5C8A", "#FF9CD1"] },
  { id: "rose", name: "Rose", colors: ["#FF3CAC", "#FF8FB1"] },
  { id: "berry", name: "Berry", colors: ["#C724B1", "#FF4DCB"] },
  { id: "orchid", name: "Orchid", colors: ["#B621FE", "#1FD1F9"] },
  { id: "plum", name: "Plum", colors: ["#6A11CB", "#2575FC"] },
  { id: "galaxy", name: "Galaxy", colors: ["#3A1C71", "#D76D77"] },
  { id: "nebula", name: "Nebula", colors: ["#654EA3", "#EAAFC8"] },
  { id: "cosmos", name: "Cosmos", colors: ["#0F0C29", "#7F00FF"] },
  { id: "aurora2", name: "Aurora II", colors: ["#00C9FF", "#92FE9D"] },
  { id: "jade", name: "Jade", colors: ["#11998E", "#38EF7D"] },
  { id: "mint", name: "Mint", colors: ["#00B09B", "#96C93D"] },
  { id: "forest", name: "Forest", colors: ["#134E5E", "#71B280"] },
  { id: "moss", name: "Moss", colors: ["#56AB2F", "#A8E063"] },
  { id: "lime", name: "Lime", colors: ["#A8FF78", "#78FFD6"] },
  { id: "teal", name: "Teal", colors: ["#1A2980", "#26D0CE"] },
  { id: "ocean", name: "Ocean", colors: ["#2E3192", "#1BFFFF"] },
  { id: "lagoon", name: "Lagoon", colors: ["#43C6AC", "#191654"] },
  { id: "abyss", name: "Abyss", colors: ["#000428", "#004E92"] },
  { id: "midnight", name: "Midnight", colors: ["#232526", "#414345"] },
  { id: "steel", name: "Steel", colors: ["#373B44", "#4286F4"] },
  { id: "slate", name: "Slate", colors: ["#283048", "#859398"] },
  { id: "graphite", name: "Graphite", colors: ["#3E5151", "#DECBA4"] },
  { id: "sand", name: "Sand", colors: ["#EACDA3", "#D6AE7B"] },
  { id: "honey", name: "Honey", colors: ["#F7971E", "#FFD200"] },
  { id: "gold", name: "Gold", colors: ["#FDC830", "#F37335"] },
  { id: "citrus", name: "Citrus", colors: ["#F09819", "#EDDE5D"] },
  { id: "mango", name: "Mango", colors: ["#FFE259", "#FFA751"] },
  { id: "sunrise", name: "Sunrise", colors: ["#FF512F", "#F09819"] },
  { id: "cherry", name: "Cherry", colors: ["#EB3349", "#F45C43"] },
  { id: "crimson", name: "Crimson", colors: ["#8E0E00", "#1F1C18"] },
  { id: "wine", name: "Wine", colors: ["#56242A", "#9E2A2B"] },
  { id: "raspberry", name: "Raspberry", colors: ["#E91E63", "#9C27B0"] },
  { id: "lilac", name: "Lilac", colors: ["#A18CD1", "#FBC2EB"] },
  { id: "lavender", name: "Lavender", colors: ["#9D50BB", "#6E48AA"] },
  { id: "royal", name: "Royal", colors: ["#141E30", "#243B55"] },
  { id: "sapphire", name: "Sapphire", colors: ["#0052D4", "#65C7F7"] },
  { id: "electric", name: "Electric", colors: ["#4776E6", "#8E54E9"] },
  { id: "glacier", name: "Glacier", colors: ["#83A4D4", "#B6FBFF"] },
  { id: "arctic", name: "Arctic", colors: ["#A1FFCE", "#FAFFD1"] },
  { id: "sky", name: "Sky", colors: ["#56CCF2", "#2F80ED"] },
  { id: "breeze", name: "Breeze", colors: ["#2BC0E4", "#EAECC6"] },
  { id: "mojito", name: "Mojito", colors: ["#1D976C", "#93F9B9"] },
  { id: "emerald", name: "Emerald", colors: ["#348F50", "#56B4D3"] },
  { id: "toxic", name: "Toxic", colors: ["#76FF03", "#00E5FF"] },
  { id: "neonpunk", name: "Neon Punk", colors: ["#F72585", "#7209B7"] },
  { id: "vapor", name: "Vapor", colors: ["#FF6CAB", "#7366FF"] },
  { id: "synthwave", name: "Synthwave", colors: ["#FC466B", "#3F5EFB"] },
  { id: "mono", name: "Mono", colors: ["#BDC3C7", "#2C3E50"] },
];
