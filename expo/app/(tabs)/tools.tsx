...
function moduleToTool(module: SolToolsModuleSpec): Tool {
  ...
  return {
    ...
    description: module.gatedReason ?? `${module.name} is wired into ${module.surface} using the existing Crypto Community App data layer and routes.`,
...
const OG_WEB_TOOLS: OGWebTool[] = [
  ...
  { slug: "roadmap", title: "Roadmap", path: "/roadmap", page: "3", description: "Crypto Community App mission, rollout plan, and community links.", Icon: Route, accent: Colors.cyan },
