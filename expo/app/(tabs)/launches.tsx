...
const styles = StyleSheet.create({
  ...
  columnWrap: { paddingHorizontal: 16, gap: 10, marginBottom: 10 },
  ...
  dropRow: { flexDirection: "row", gap: 8, paddingHorizontal: 14, marginTop: 10, marginBottom: 14 },
  dropBtn: {
    flex: 1,
    flexDirection: "row",
    alignItems: "center",
  ...
  dropText: { flex: 1, color: Colors.text, fontSize: 12, fontWeight: "800" },
